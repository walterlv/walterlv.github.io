...
本文将教你如何使用 Directory Opus 的命令编辑器功能编辑一组比较复杂的命令——跟 TortoiseGit 进行集成。
...
现在，点击“高级...”按钮，我们将打开高级的命令编辑器。现在我们可以注意到下面出现了一个非常大的函数编辑窗口，而此前的“函数”、“开始于”、“运行”选项都消失了。这是因为此函数编辑窗口涵盖了消失的这些按钮的所有功能，而且更为强大，因为可以使用更多种类的命令。
