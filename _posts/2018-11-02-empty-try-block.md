...
需要说明的是，.NET Core 中是没有这段内容的，你可以查看 [System.Runtime.cs · dotnet/corefx](https://github.com/dotnet/corefx/blob/master/src/System.Runtime/ref/System.Runtime.cs) 的大约 1166 行，`Exception` 类型是有运行时实现的。
